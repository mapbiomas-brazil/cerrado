...
dirout = 'projects/mapbiomas-workspace/AMOSTRAS/Cerrado/col6/wetlands/training_v1_v2/'
...
pts = ee.FeatureCollection('projects/mapbiomas-workspace/AMOSTRAS/Cerrado/col6/wetlands/samples_v1/samples_wetland_col6_v1')
